...
class Net(CNN):
    ...
    def forward(self, data_dict, **kwargs):
        if 'images' in data_dict:
            ...
            U_src, U_tgt = Net.normalize_over_channels(U_src), Net.normalize_over_channels(U_tgt)
            F_src, F_tgt = Net.normalize_over_channels(F_src), Net.normalize_over_channels(F_tgt)
